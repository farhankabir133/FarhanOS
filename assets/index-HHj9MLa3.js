...
`)}const G2={[dv]:"Linear",[fv]:"Reinhard",[hv]:"Cineon",[pv]:"ACESFilmic",[gv]:"AgX",[xv]:"Neutral",[mv]:"Custom"};function j2(o,t){const i=G2[t];return i===void 0?(ht("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+o+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+o+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Oc=new oe;function V2(){Lt.getLuminanceCoefficients(Oc);const o=Oc.x.toFixed(4),t=Oc.y.toFixed(4),i=Oc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${o}, ${t}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
