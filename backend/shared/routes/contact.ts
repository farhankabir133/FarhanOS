...
import { buildContactAnalysisPrompt } from "../prompts.ts";
import { buildContactEmailHtml } from "../email.ts";
...
import type { ContactRequest, ContactAnalysis, ContactResponse } from "../types.ts";
