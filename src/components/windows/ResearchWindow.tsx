...
const ResearchWindow = memo(function ResearchWindow({ selectedPaper, onSelectPaper, panelHeader }: ResearchWindowProps) {
  ...
  return (
    <div className="flex flex-col md:flex-row h-full gap-4">
      ...
      <div className="w-full md:w-56 border-r border-[#2d2f3d] pr-4 flex flex-col gap-2">
        <span className={panelHeader}>PUBLICATIONS CATALOG</span>
      ...
      <div className="flex-1 space-y-4">
        ...
        <div>
          <span className={panelHeader}>CLASSIFIER PIPELINE DATAFLOW</span>
        ...
        <div>
          <span className={panelHeader}>EVALUATION ACCURACY STATISTICS</span>
